...
javascript:(function(){
  ...
  try {
    ...
    z.setAttribute('src', 'https://assets.listenitlater.com/js/bookmarklet.js?t=' + encodeURIComponent(d.title) + '&d=' + (new Date().getTime()));
    b.appendChild(z);
  }
  catch (e) {
    if (e === 0) {
      ...
      alert("ListenToItLater currently only works with SoundCloud.");
    }
    else {
